...
def groupby_crimetype_month(latitude, longitude, distance = 1000, crimeToshow = 10, processingType= "batch"):
...
def groupby_crimetype(latitude, longitude, distance = 1000, crimeToshow = 10, processingType= "batch"):
	currentDateStr = str(datetime.datetime.now().year) + "-" + str(datetime.datetime.now().month) + "-" + str(datetime.datetime.now().day)
	pastDateStr = str(datetime.datetime.now().year - 4) + "-" + str(datetime.datetime.now().month) + "-" + str(datetime.datetime.now().day)
...
def crimesBatchStatistics(latitude, longitude, distance = 1000, crimeToshow = 10, processingType= "batch"):
