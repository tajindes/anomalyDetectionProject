...
public class generateUserData {
    ...
    //Date Rptd,DR NO,DATE OCC,TIME OCC,AREA,AREA NAME,RD,Crm Cd,Crm Cd Desc,Status,Status Desc,LOCATION,Cross Street,Location 1,crimeType
        try
        {
            ...
            writer.append("Date Rptd");
            writer.append(',');
            writer.append("DR NO");
            writer.append(',');
            writer.append("DATE OCC");
            writer.append(',');
            writer.append("TIME OCC");
            writer.append(',');
            writer.append("AREA");
            writer.append(',');
            writer.append("AREA NAME");
            writer.append(',');
            writer.append("RD");
            writer.append(',');
            writer.append("Crm Cd");
            writer.append(',');
            writer.append("Crd Cd Desc");
            writer.append(',');
            ...
            writer.append(',');
            writer.append("Cross Street");
            writer.append(',');
            writer.append("Location 1");
            writer.append(',');
    ...
    public static void writeUserData(String sFileName, String numberOfRecords_str) {
        ...
        try
        {
            ...
            for (int count=0;count<numberOfRecords;count++){                 
                ...
                Date date_rptd_random = new Date(beginTime + (long) (Math.random() * diff));
                Date date_occ_random = new Date(beginTime + (long) (Math.random() * diff));

                String dr_no_random = ""+ randInt(140000000, 149999999);
                String time_occ_random = "" + randInt(1,24) + "" + randInt(10,60);
                ...
                while(date_rptd_random.after(date_occ_random)) {
