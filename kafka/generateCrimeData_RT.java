...
public class generateCrimeData_RT {
...
*/
    ...
    public static void writeUserData(String sFileName, String numberOfRecords_str) {
		...
		String crime_id = "crime" + tempValue;
		...
		writer.append(crimeType_random);
                writer.append(',');
                writer.append(crime_date_str);
		writer.append(',');
		writer.append(crime_time_str);
                writer.append('\n');
